  ...
  return (
    <MotionSection className="bg-muted/30 py-20">
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <MotionStagger className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {painPoints.map((pain) => (
            <MotionCard key={pain.title}>
              <Card className="border-destructive/20 h-full transition-colors hover:border-destructive/40">
