...
### [ALTO] UX-001: Clave i18n expuesta al usuario en pagina de Tarifas
...
### [MEDIO] UX-002: Signout page en ingles (NextAuth default)
...
### [MEDIO] UX-003: Tabla de personal en Organizacion sin paginacion
...
### [BAJO] UX-004: Encabezado de pagina duplicado en varias secciones
...
### [BAJO] UX-005: Sidebar muestra "Jefe de Sector" en vez de "Jefe de Area" para CHIEF_AREA
...
### [ALTO] UX-006: Seccion de documento/RUT al final del perfil en vez de arriba
...
### [ALTO] UX-007: Calendario de fecha de nacimiento sin selector de ano - imposible elegir fecha lejana
...
### [MEDIO] UX-008: Input de telefono acepta letras y caracteres invalidos
...
### [MEDIO] UX-009: Placeholder de telefono en formato US para usuario chileno
- **Ubicacion:** `/es/dashboard/profile` - campo "Telefono"
- **Rol:** Todos
- **Test Case:** TC-ST-019
- **Pasos para reproducir:**
...
### [BAJO] UX-010: Input de telefono sin maxLength
- **Ubicacion:** `/es/dashboard/profile` - campo "Telefono"
- **Rol:** Todos
