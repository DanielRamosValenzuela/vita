    ...
    <PageAnimationWrapper className="flex flex-col">
      ...
      <PageSection className="bg-primary/5 py-20">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          <h2 className="mb-6 text-3xl font-bold tracking-tight">{t('mission.title')}</h2>
      ...
      <PageSection className="bg-background py-20">
        <div className="container mx-auto max-w-4xl px-4">
          <h2 className="mb-10 text-3xl font-bold tracking-tight">{t('story.title')}</h2>
          <div className="space-y-6">
            <p className="text-muted-foreground text-lg leading-relaxed">{t('story.p1')}</p>
            <p className="text-muted-foreground text-lg leading-relaxed">{t('story.p2')}</p>
            <p className="text-muted-foreground text-lg leading-relaxed">{t('story.p3')}</p>
          </div>
        </div>
      </PageSection>
              ...
              return (
                <Card key={key} className="text-center transition-shadow hover:shadow-lg">
                  <CardHeader className="items-center pb-2">
                    ...
                    <h3 className="text-xl font-semibold">{t(`values.${valueKey}.title`)}</h3>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground">{t(`values.${valueKey}.description`)}</p>
                  </CardContent>
                </Card>
              )
            })}
